...
class Move {
    ...
    boolean isExtend() {
        if ((Math.abs(_col0 - _col1) == 1 && _row0 == _row1)
            || (Math.abs(_row0 - _row1) == 1 && _col0 == _col1)
            || (Math.abs(_row0 - _row1) == 1 && Math.abs(_col0 - _col1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    boolean isJump() {
        if ((Math.abs(_col0 - _col1) <= 2 && Math.abs(_row0 - _row1) == 2)
            || (Math.abs(_col0 - _col1) == 2 && Math.abs(_row0 - _row1) <= 2)) {
            return true;
        }
        return false;
    }
